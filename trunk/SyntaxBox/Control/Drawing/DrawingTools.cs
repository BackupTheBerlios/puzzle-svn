...
namespace Puzzle.Drawing
{
    ...
    public sealed class DrawingTools
    {
        ...
        {
            var normal = new SolidBrush(BorderColor);
                ...
                case BorderStyle2.Column:
                    {
                        ...
                        var darkdark = new SolidBrush(Color.FromArgb(BorderColor.A, ControlPaint.DarkDark(BorderColor)));
        ...
        {
            var p = new Pen(SystemColors.ControlDarkDark);
            p.DashOffset = 10;
            p.DashStyle = DashStyle.Dash;

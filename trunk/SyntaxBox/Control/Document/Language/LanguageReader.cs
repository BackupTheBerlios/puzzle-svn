...
namespace Puzzle.SourceCode
{
    ...
    public class SyntaxDefinitionLoader
    {
        ...
        private SyntaxDefinition mSyntaxDefinition = new SyntaxDefinition();
        private Hashtable mStyles = new Hashtable();
        //protected BlockType		mSyntaxDefinition.MainBlock=null;
        ...
        public SyntaxDefinition Load(string File)
        {
            ...
            mSyntaxDefinition = new SyntaxDefinition();
        ...
        public SyntaxDefinition Load(string File, string Separators)
        {
            ...
            mBlocks = new Hashtable();
            mSyntaxDefinition = new SyntaxDefinition();
            mSyntaxDefinition.Separators = Separators;

            var myXmlDocument = new XmlDocument();
            myXmlDocument.Load(File);
            ReadLanguageDef(myXmlDocument);

            if (mSyntaxDefinition.MainBlock == null)
            {
        ...
        private void ParseLanguage(XmlNode node)
        {
            ...
            mSyntaxDefinition.Name = Name;
            mSyntaxDefinition.MainBlock = GetBlock(StartBlock);
            ...
            foreach (XmlNode n in node.ChildNodes)
            {
                if (n.NodeType == XmlNodeType.Element)
                {
                        ...
                        == "filetype")
                    {
                        ...
                        ft.Name = Name;
                        mSyntaxDefinition.FileTypes.Add(ft);
                    }
                }
            }
        }
                ...
                if (n.NodeType == XmlNodeType.Element)
                {
                        ...
                        == "scope")
                    {
                        ...
                        if (Start != "")
                        {
                            ...
                            var StartP = new Pattern(Start, blnStartIsComplex, false,
                        ...
                        == "bracket")
                    {
                        ...
                        if (Start != "")
                        {
                            ...
                            var StartP = new Pattern(Start, blnStartIsComplex, false,
                                                     bool.Parse(StartIsKeyword));
                            var EndP = new Pattern(End, blnEndIsComplex, false,
                            ...
                            == "patterngroup")
                        {
                            ...
                            foreach (XmlNode pt in cn.ChildNodes)
                            {
                                    ...
                                    "pattern")
                                {
                                    ...
                                    if (Pattern != "")
                                    {
                                        var pat = new Pattern(Pattern, IsComplex, IsSeparator,
                                                              true);

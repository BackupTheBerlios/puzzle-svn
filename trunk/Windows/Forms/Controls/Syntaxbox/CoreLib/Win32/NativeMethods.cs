...
*/
		...
		public static extern int EnumFontFamiliesEx(IntPtr hDC, LogFont lf, FONTENUMPROC proc, Int64 LParam, Int64 DW);
		...
		[DllImport("gdi32.dll")]
		public static extern IntPtr CreateFontIndirect(LogFont LogFont);
		...
		[DllImport("gdi32.dll")]
		public static extern IntPtr MoveToEx(IntPtr hDC, int x, int y, APIPoint lpPoint);

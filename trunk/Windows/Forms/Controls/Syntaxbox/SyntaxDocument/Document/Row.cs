...
{	
	...
	public sealed class Row:IEnumerable
	{
		...
		private	  WordCollection			mWords				=new WordCollection ();
		/// <summary>
...
//					return 0;
		...
		public Row	NextVisibleRow
		{
			get
			{
				try
				{
					...
					if (i>=this.Document.VisibleRows.Count-1)
						return null;
		...
		public bool CanFold
		{
			get
			{
				return (this.Expansion_StartSegment != null  &&  this.Expansion_StartSegment.EndRow != null && this.Document.IndexOf (this.Expansion_StartSegment.EndRow) != 0);
			}
		}
		...
		public string ExpansionText
		{
			get
			{
				return this.Expansion_StartSegment.Scope.ExpansionText;
			}
			set
			{
		...
		public bool CanFoldEndPart
		{
			get
			{
				return (this.Expansion_EndSegment != null);
			}
		}

...
{
	/// <summary>
	/// Summary description for ListPartialAuction.
	/// </summary>
	[TestFixture()]
	public class ListPartialAuction : NTorpedoClient, ITest
	{
		public static string TestName = "ListPartialAuction";

		public ListPartialAuction() : base(TestName)
		{
		}

		public ListPartialAuction(string url) : base(TestName, url)
		{
		}

...
Public Class GenDomWizardService
    ...
    Private Function DoExecuteWizard( _
        ...
        Try
            ...
            'Generate the table model and O/R Mappings
            newDomainMap = DoClassesToTables( _
                project, _
                domainMap, _
                sourceType, _
                providerType, _
        ...
        Catch ex As Exception
            ...
            Throw New Exception("Failed generating table model from class model! Reason:" & vbCrLf & ex.Message)
        ...
        Catch ex As Exception
            ...
            Throw New Exception("Failed generating the database for the table model! Reason:" & vbCrLf & ex.Message)
    ...
    Private Function DoClassesToTables( _
        ByVal project As ProjectModel.IProject, _
        ByVal domainMap As IDomainMap, _
        ByVal sourceType As SourceType, _
        ByVal providerType As ProviderType, _
        ...
        Dim tool As IClassesToTables = New ClassesToTables

        Dim targetDomainMap As IDomainMap = New domainMap

        domainMap.Copy(targetDomainMap)

        tool.GenerateTablesForClasses(domainMap, targetDomainMap, True)
    ...
    Private Function GetNewConfigName( _
        ...
        Dim baseName As String = "Implement Class Model Wizard Config"

...
Public Class ClassesToCodeCs2
                    ...
                    If ImplementShadows OrElse classMap.IsShadowingProperty(propertyMap) = False Then
                        ...
                        Else
                            ...
                            Else
                                ...
                                'TODO: Mats , this should only be used for fields with no set prop
    ...
    Public Overrides Function DomainToProject(ByVal domainMap As IDomainMap, ByVal projPath As String, ByVal classMapsAndFiles As Hashtable, ByVal embeddedFiles As ArrayList) As String
        ...
        codeBuilder.Append("<Project DefaultTargets=""Build"" xmlns=""http://schemas.microsoft.com/developer/msbuild/2003"">")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("    <PropertyGroup>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <ProjectType>Local</ProjectType>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <ProductVersion>8.0.50727</ProductVersion>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <SchemaVersion>2.0</SchemaVersion>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <ProjectGuid>{" & Guid.NewGuid.ToString & "}</ProjectGuid>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <Configuration Condition="" '$(Configuration)' == '' "">Debug</Configuration>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <Platform Condition="" '$(Platform)' == '' "">AnyCPU</Platform>")
        codeBuilder.Append(vbCrLf)
        ...
        codeBuilder.Append("        </AssemblyKeyContainerName>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <AssemblyName>" & domainMap.Name & "</AssemblyName>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <AssemblyOriginatorKeyFile>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        </AssemblyOriginatorKeyFile>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <DefaultClientScript>JScript</DefaultClientScript>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <DefaultHTMLPageLayout>Grid</DefaultHTMLPageLayout>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <DefaultTargetSchema>IE50</DefaultTargetSchema>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <DelaySign>false</DelaySign>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <OutputType>Library</OutputType>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <RootNamespace>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        </RootNamespace>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <RunPostBuildEvent>OnBuildSuccess</RunPostBuildEvent>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <StartupObject>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        </StartupObject>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <FileUpgradeFlags>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        </FileUpgradeFlags>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <UpgradeBackupLocation>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        </UpgradeBackupLocation>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("    </PropertyGroup>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("    <PropertyGroup Condition="" '$(Configuration)|$(Platform)' == 'Debug|AnyCPU' "">")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <OutputPath>bin\Debug\</OutputPath>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <AllowUnsafeBlocks>false</AllowUnsafeBlocks>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <BaseAddress>285212672</BaseAddress>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <CheckForOverflowUnderflow>false</CheckForOverflowUnderflow>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <ConfigurationOverrideFile>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        </ConfigurationOverrideFile>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <DefineConstants>DEBUG;TRACE</DefineConstants>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <DocumentationFile>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        </DocumentationFile>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <DebugSymbols>true</DebugSymbols>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <FileAlignment>4096</FileAlignment>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <NoStdLib>false</NoStdLib>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <NoWarn>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        </NoWarn>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <Optimize>false</Optimize>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <RegisterForComInterop>false</RegisterForComInterop>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <RemoveIntegerChecks>false</RemoveIntegerChecks>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <TreatWarningsAsErrors>false</TreatWarningsAsErrors>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <WarningLevel>4</WarningLevel>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <DebugType>full</DebugType>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <ErrorReport>prompt</ErrorReport>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("    </PropertyGroup>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("    <PropertyGroup Condition="" '$(Configuration)|$(Platform)' == 'Release|AnyCPU' "">")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <OutputPath>bin\Release\</OutputPath>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <AllowUnsafeBlocks>false</AllowUnsafeBlocks>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <BaseAddress>285212672</BaseAddress>")
        ...
        codeBuilder.Append("        </ConfigurationOverrideFile>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <DefineConstants>TRACE</DefineConstants>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <DocumentationFile>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        </DocumentationFile>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <DebugSymbols>false</DebugSymbols>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <FileAlignment>4096</FileAlignment>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <NoStdLib>false</NoStdLib>")
        ...
        codeBuilder.Append("        </NoWarn>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <Optimize>true</Optimize>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <RegisterForComInterop>false</RegisterForComInterop>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <RemoveIntegerChecks>false</RemoveIntegerChecks>")
        ...
        codeBuilder.Append("        <WarningLevel>4</WarningLevel>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <DebugType>none</DebugType>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <ErrorReport>prompt</ErrorReport>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("    </PropertyGroup>")
        ...
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <Reference Include=""System"">")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <Name>System</Name>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        </Reference>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <Reference Include=""System.Data"">")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <Name>System.Data</Name>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        </Reference>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <Reference Include=""System.Xml"">")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        <Name>System.XML</Name>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("        </Reference>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("    </ItemGroup>")
        ...
        For Each filePath In classMapsAndFiles.Values
            ...
            codeBuilder.Append("        <Compile Include=""" & GetFilePathRelativeToProject(projPath, filePath) & """>")
            codeBuilder.Append(vbCrLf)
            codeBuilder.Append("            <SubType>Code</SubType>")
            codeBuilder.Append(vbCrLf)
            codeBuilder.Append("        </Compile>")
            codeBuilder.Append(vbCrLf)
        Next

        For Each filePath In embeddedFiles

            codeBuilder.Append("        <EmbeddedResource Include=""" & GetFilePathRelativeToProject(projPath, filePath) & """ />")
            codeBuilder.Append(vbCrLf)
        ...
        codeBuilder.Append("    </ItemGroup>")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("    <Import Project=""$(MSBuildBinPath)\Microsoft.CSharp.targets"" />")
        codeBuilder.Append(vbCrLf)
        codeBuilder.Append("    <PropertyGroup>")
        codeBuilder.Append(vbCrLf)

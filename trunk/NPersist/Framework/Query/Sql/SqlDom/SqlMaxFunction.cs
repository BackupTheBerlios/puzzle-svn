...
namespace Puzzle.NPersist.Framework.Sql.Dom
{
	...
	/// </summary>
	public class SqlMaxFunction : SqlFunction
	{
		...
		public SqlMaxFunction(SqlExpression sqlExpression) : this(sqlExpression, false)
		{
		}

		public SqlMaxFunction() : this(null, false)
		{
		}

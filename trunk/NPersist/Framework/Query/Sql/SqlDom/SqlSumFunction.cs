...
namespace Puzzle.NPersist.Framework.Sql.Dom
{
	...
	/// </summary>
	public class SqlSumFunction : SqlFunction
	{
		public SqlSumFunction(SqlExpression sqlExpression, bool distinct)
		{
			this.sqlExpression = sqlExpression;
			this.distinct = distinct;
		}

		public SqlSumFunction(SqlExpression sqlExpression) : this(sqlExpression, false)
		{
		}

		public SqlSumFunction() : this(null, false)
		{
		}

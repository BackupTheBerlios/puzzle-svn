...
//						om.SetUpdatedStatus(value, invPropertyMap.Name, true);
//
//						if (!(om.HasOriginalValues(value, invPropertyMap.Name)))
//						{
//							om.SetOriginalPropertyValue(value, invPropertyMap.Name, this.Context.ListManager.CreateList(value, invPropertyMap));
//						}
//						list = (IList) om.GetOriginalPropertyValue(value, invPropertyMap.Name);
//						mList = list as IInterceptableList;					
//						if (mList != null)
//						{
//							stackMute = mList.MuteNotify;
...
//					}
//
//					if (invPropertyMap.ReferenceType == ReferenceType.OneToOne)
//					{
//					
//					}
//				

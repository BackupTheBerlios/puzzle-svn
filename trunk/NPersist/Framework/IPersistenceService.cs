...
namespace Puzzle.NPersist.Framework 
{
	...
	public interface IPersistenceService : IDisposable
	{
		...
		/// <summary>
		/// Create a new object with the specified identity and type, registering it as up for creation. It will be inserted into the data source on the next call to <c>PersistAll</c>.
		/// Use this overload only for objects that do not have their identities generated by the data source or by an <c>IdentityGenerator</c>.
		/// </summary>
		...
		/// <summary>
		/// Create a new object with the specified type, registering it as up for creation. It will be inserted into the data source in the next call to <c>PersistAll</c>. 
		/// Use this overload only for objects that have their identities generated by the data source or by an <c>IdentityGenerator</c>.
		/// </summary>
		/// <param name="type">The type of the new object</param>
		/// <param name="ctorParams">Contructor parameters for the new object</param>
		...
		/// <summary>
		/// Register an object as up for deletion. The object will be removed from the data source on the next call to <c>PersistAll</c>.
		/// </summary>
		...
		/// <summary>
		/// Persist all changes to the data source, inserting all new objects, removing all deleted object and saving all modified objects.
		/// </summary>
		void Commit();

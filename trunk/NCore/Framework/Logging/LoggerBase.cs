...
namespace Puzzle.NCore.Framework.Logging
{
	...
	public class LoggerBase : ILogger
	{
		...
		public LoggerBase(bool isDebugEnabled, bool isInfoEnabled, bool isWarnEnabled, bool isErrorEnabled, bool isFatalEnabled)
		{
		...
		public LoggerBase(bool isDebugEnabled, bool isInfoEnabled, bool isWarnEnabled, bool isErrorEnabled, bool isFatalEnabled, bool isVerboseEnabled)
		{
			this.isDebugEnabled = isDebugEnabled;
			this.isInfoEnabled = isInfoEnabled;
			this.isWarnEnabled = isWarnEnabled;
		...
		public virtual bool IsVerboseEnabled
		{
			...
			set { this.isVerboseEnabled = value; }
		}
